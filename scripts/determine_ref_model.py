...
def determine_ref_model():
    """
    This is the main function. It determines the best reference model 
    for a set of PDB files.It does so by calculating the pairwise RMSD 
    values between the ligand coordinates in each PDB file. The PDB file 
    with the lowest average RMSD value is suggested.
    """
