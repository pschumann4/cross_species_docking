...
def get_centroid(pdb_file):
    ...
    residues = input('Enter a comma-separated list of binding site residue numbers (e.g., "343, 345, 367" or if chain info is present "A_343, A_345, A_367"): ')
    ...
    if "_" in residues[0]:
        ...
        pass
    # Read the lines in the PDB file and extract the coordinates of the specified residues
    coords = []
...
# Create a function that will read a PDB file and return the centroid coordinates from a user-supplied list of residues
def get_bindingsite_coords():
    ...
    if check_exit(num_sites):
        return
    # Use the get_centroid() function to get the centroid coordinates for each binding site
    site_coords = {}
